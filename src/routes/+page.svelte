<script>
    ...
    async function getallfortniteskins() {
        ...
        data.data.entries = data.data.entries.filter(item => item.layout ? item.layout.name != 'Jam Tracks' && item.layout.name != 'OG Season Shop' && item.layout.name != 'Prove Your Power' && item.layoutId != 'alc.0' : true);
